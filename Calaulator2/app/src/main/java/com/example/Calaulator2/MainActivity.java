package com.example.Calaulator2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume(){
        super.onResume();
        SharedPreferences appSharePerfs = getSharedPreferences("pre_value", MODE_PRIVATE);
        theValue = (new Integer(appSharePerfs.getString("newItem","0"))).intValue();
    }
